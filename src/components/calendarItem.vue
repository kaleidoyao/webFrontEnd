  ...
  <div class="calendar-wrap">
    ...
    <table class="calendar">
      ...
      <tr class="week">
        ...
        <td class="day today" tabindex="0"><span class="day-number">20</span></td>
...
.calendar-wrap {
  ...
  border-radius: 1.5em;
  user-select: none;
  box-shadow: 0 0.0625em 0.25em rgba(0, 20, 50, 0.2),
...
.day.range.active-a:first-child + .day.range.active-b {
  box-shadow: -1.5em 0 #e1f5fe, inset 1.5em 0 #e1f5fe;
}
