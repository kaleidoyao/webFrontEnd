<template>
  <tag-cloud></tag-cloud>
<!--  <link href="https://fonts.googleapis.com/css2?family=EB+Garamond:wght@400&display=swap" rel="stylesheet">  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display+SC:wght@700&display=swap" rel="stylesheet">-->
...
<!--      </p></a><a class="item-with-image toggles" href="https://codepen.io/oliviale/full/xxboXzo" target="_blank"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/showcase-toggle.gif"/>-->
<!--      <h4>Toggles</h4>-->
...
export default {
  ...
  components: {TagCloud, BackGround},
  data() {
    return {
...
@media (min-width: 700px) and (max-width: 1024px) {
  .hogwarts__title {
    font: 800 21px/1.2 v-bind(font_sans_serif);
...
.workout__blurb {
  font: 22px/1.1 v-bind(font_sans_serif);
  text-align: center;
  padding: 0.5rem;
  color: v-bind(black);
...
.workout__title {
  font: 18px/1.1 v-bind(font_sans_serif);
  text-transform: uppercase;
  text-align: center;
  padding: 1rem;
  background: v-bind(black);
